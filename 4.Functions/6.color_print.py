...
# colorama enables ANSI to the windows statement and direct all print
# statement to the windows API
import colorama
...
print(YELLOW, "this will be yellow")
print(GREEN, "this will be green")
"""
...
colorama.init()
colour_print("Hello, in Red and Bold", RED, BOLD)
# test that the colour was reset
print("This should be in the default terminal colour")
colour_print("Hello, Blue", BLUE)
colour_print("Hello, Yellow is Bold, reversed and underlined", YELLOW, BOLD, REVERSE, UNDERLINE)
